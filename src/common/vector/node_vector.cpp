...
void NodeIDVector::get(uint64_t index, nodeID_t& nodeID) {
    ...
    case LABEL_0_NODEOFFSET_2_BYTES:
        nodeID.offset = ((uint16_t*)nodeIDs)[index];
        break;
    case LABEL_0_NODEOFFSET_4_BYTES:
        nodeID.offset = ((uint32_t*)nodeIDs)[index];
        break;
    case LABEL_0_NODEOFFSET_8_BYTES:
        nodeID.offset = ((node_offset_t*)nodeIDs)[index];
        break;
    case LABEL_1_NODEOFFSET_2_BYTES:
        nodeID.label = ((nodeID_8_16_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_8_16_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_1_NODEOFFSET_4_BYTES:
        nodeID.label = ((nodeID_8_32_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_8_32_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_1_NODEOFFSET_8_BYTES:
        nodeID.label = ((nodeID_8_64_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_8_64_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_2_NODEOFFSET_2_BYTES:
        nodeID.label = ((nodeID_16_16_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_16_16_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_2_NODEOFFSET_4_BYTES:
        nodeID.label = ((nodeID_16_32_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_16_32_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_2_NODEOFFSET_8_BYTES:
        nodeID.label = ((nodeID_16_64_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_16_64_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_4_NODEOFFSET_2_BYTES:
        nodeID.label = ((nodeID_32_16_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_32_16_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_4_NODEOFFSET_4_BYTES:
        nodeID.label = ((nodeID_32_32_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_32_32_t*)nodeIDs)[index].nodeOffset;
        break;
    case LABEL_4_NODEOFFSET_8_BYTES:
        nodeID.label = ((nodeID_t*)nodeIDs)[index].label;
        nodeID.offset = ((nodeID_t*)nodeIDs)[index].offset;
        break;
    default:
