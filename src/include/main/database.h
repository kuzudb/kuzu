...
struct KUZU_API SystemConfig {
     ...
     * applicable for Swift integration on Apple platforms. It determines the priority of the threads
     * used for query execution. The default value is `QOS_CLASS_DEFAULT`.
     */
