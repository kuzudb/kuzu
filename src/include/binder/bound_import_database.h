...
private:
    std::string filePath;
    // We concatenate queries based on the schema.cypher, copy.cypher, and macro.cypher files generated by exporting the database,
    // resulting in queries such as "create node table xxx; create rel table xxx; copy from xxxx;".
    std::string query;
};
