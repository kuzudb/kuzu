...
private:
    ...
    common::table_id_set_t collectRelNodes(const std::string direction,
    ...
    std::vector<TableCatalogEntry*> pruneUnRecursiveRel(
    ...
    static bool same(std::vector<catalog::TableCatalogEntry*> v1,
        std::vector<catalog::TableCatalogEntry*> v2) {
