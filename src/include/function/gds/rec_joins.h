...
struct RJCompState : public GDSComputeState {
    ...
    RJCompState(std::unique_ptr<function::FrontierPair> frontierPair,
        std::unique_ptr<function::EdgeCompute> edgeCompute, processor::NodeOffsetMaskMap* outputNodeMask, std::unique_ptr<RJOutputs> outputs,
        std::unique_ptr<RJOutputWriter> outputWriter)
    ...
    // e.g., maps, internally.
    void beginFrontierComputeBetweenTables(common::table_id_t currTableID, common::table_id_t nextTableID) override {
