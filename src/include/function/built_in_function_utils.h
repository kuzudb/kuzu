...
public:
    ...
    static KUZU_API std::string getFunctionMatchFailureMsg(const std::string name, const std::vector<common::LogicalType>& inputTypes, const std::string& supportedInputs, bool isDistinct = false);
