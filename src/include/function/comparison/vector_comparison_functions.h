...
struct ComparisonFunction {
    ...
    static function_set getFunctionSet(const std::string& name) {
        ...
        functionSet.push_back(getFunction<OP>(
            name, common::LogicalTypeID::STRUCT, common::LogicalTypeID::STRUCT));
        functionSet.push_back(getFunction<OP>(
            name, common::LogicalTypeID::NODE, common::LogicalTypeID::NODE));
        functionSet.push_back(getFunction<OP>(
            name, common::LogicalTypeID::REL, common::LogicalTypeID::REL));
