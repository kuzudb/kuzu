...
public:
    explicit LogicalMultiplicityReducer(std::shared_ptr<LogicalOperator> child, std::unique_ptr<OPPrintInfo> printInfo)
        : LogicalOperator(LogicalOperatorType::MULTIPLICITY_REDUCER, std::move(child), std::move(printInfo)) {}
