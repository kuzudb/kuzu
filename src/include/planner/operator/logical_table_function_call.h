...
public:
    LogicalTableFunctionCall(function::TableFunction tableFunc,
        ...
        std::shared_ptr<binder::Expression> offset, common::column_id_t numExtraDataColumns = 0)
        : LogicalOperator{operatorType_}, tableFunc{tableFunc}, bindData{std::move(bindData)},
          columns{std::move(columns)}, numExtraDataColumns(numExtraDataColumns),
    ...
    common::column_id_t getNumExtraDataColumns() const { return numExtraDataColumns; }
