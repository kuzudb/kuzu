...
public:
    LogicalExportDatabase(common::FileScanInfo boundFileInfo,
        ...
        : LogicalSimple{type_, plans}, boundFileInfo{std::move(boundFileInfo)},
          schemaOnly{exportSchemaOnly}, sortInternalIds_{sortInternalIds} {}
