...
struct DataPartition {
    std::vector<std::unique_ptr<common::DataChunk>> chunks;
};
...
struct PartitioningBuffer {
    std::vector<std::unique_ptr<DataPartition>> partitions;
...
private:
    ...
    static void copyDataToPartitions(common::ValueVector* partitionIdxes,
        common::DataChunk* chunkToCopyFrom, PartitioningBuffer* partitioningState,
