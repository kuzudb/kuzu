...
struct RelBatchInsertInfo final : BatchInsertInfo {
    ...
    RelBatchInsertInfo(bool compressionEnabled,
        ...
        : BatchInsertInfo{compressionEnabled, std::move(columnIDs),
