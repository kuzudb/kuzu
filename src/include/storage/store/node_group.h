...
public:
    ...
    void initializeScanState(const transaction::Transaction* transaction,
        const common::UniqLock& lock, const TableScanState& state) const;
    ...
    void update(transaction::Transaction* transaction, common::row_idx_t rowIdxInGroup,
        common::column_id_t columnID, const common::ValueVector& propertyVector) const;
    bool delete_(const transaction::Transaction* transaction,
