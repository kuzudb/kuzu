...
//           chunkedGroups{ResidencyState::IN_MEMORY, this->dataTypes}, numRows{0} {}
//
...
//     }
//     void append(common::offset_t offset, ChunkedNodeGroup* nodeGroup, common::offset_t
//     numValues);
...
// public:
//     explicit LocalTableData(common::table_id_t tableID, std::vector<common::LogicalType>
//     dataTypes)
