...
public:
  ...
  enum {
    ...
    RuleOC_StringOperatorExpression = 74, RuleOC_NullOperatorExpression = 75, 
    RuleOC_PropertyOrLabelsExpression = 76, RuleOC_Atom = 77, RuleOC_Literal = 78, 
    RuleOC_BooleanLiteral = 79, RuleOC_ListLiteral = 80, RuleOC_ParenthesizedExpression = 81, 
    RuleOC_FunctionInvocation = 82, RuleOC_FunctionName = 83, RuleOC_ExistentialSubquery = 84, 
    RuleOC_PropertyLookup = 85, RuleOC_Variable = 86, RuleOC_NumberLiteral = 87, 
    RuleOC_Parameter = 88, RuleOC_PropertyExpression = 89, RuleOC_PropertyKeyName = 90, 
    RuleOC_IntegerLiteral = 91, RuleOC_DoubleLiteral = 92, RuleOC_SchemaName = 93, 
    RuleOC_SymbolicName = 94, RuleOC_LeftArrowHead = 95, RuleOC_RightArrowHead = 96, 
    RuleOC_Dash = 97
  };
