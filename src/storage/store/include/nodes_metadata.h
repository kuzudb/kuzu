...
// TODO(Reviewer): This file contains 3 classes. We can put them into their own files or just
// separate NodeOffsetsInfo into its own file.
...
public:
    ...
    // TODO(Reviewer): Is "other" the right argument name in our convention for copy constructors?
...
public:
    ...
    void writeNodesMetadataWALFile(const string& directory);
    ...
    static void saveToFile(const string& directory, bool isForWALRecord,
        ...
        vector<vector<uint64_t>>& deletedNodeOffsetsPerLabel);
