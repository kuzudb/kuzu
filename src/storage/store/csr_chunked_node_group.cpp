...
std::unique_ptr<ChunkedNodeGroup> ChunkedCSRNodeGroup::flushAsNewChunkedNodeGroup(
    ...
    auto csrOffset = csrHeader.offset->flushAsNewColumnChunk(dataFH);
    auto csrLength = csrHeader.length->flushAsNewColumnChunk(dataFH);
