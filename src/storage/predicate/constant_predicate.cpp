...
template <typename T>
ZoneMapCheckResult checkZoneMapSwitch(const CompressionMetadata& metadata, ExpressionType expressionType, const Value& value) {
...
ZoneMapCheckResult ColumnConstantPredicate::checkZoneMap(const CompressionMetadata& metadata) const {
