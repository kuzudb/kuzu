...
DictionaryColumn::DictionaryColumn(const std::string& name, PageAllocator& pageAllocator,
    ...
    dataColumn = std::make_unique<Column>(dataColName, LogicalType::UINT8(), pageAllocator, mm,
