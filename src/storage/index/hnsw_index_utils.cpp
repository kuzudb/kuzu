...
double HNSWIndexUtils::computeDistance(DistFuncType funcType, const EmbeddingColumn& embeddings,
    ...
    const auto right = embeddings.getEmebdding(rightOffset, transaction);
    double distance = 0.0;
    KU_ASSERT(
