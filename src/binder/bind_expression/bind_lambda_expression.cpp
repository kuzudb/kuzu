...
void ExpressionBinder::bindLambdaExpression(const std::string& functionName, const Expression& lambdaInput, Expression& lambdaExpr) {
    ...
    auto& parsedLambdaExpr = boundLambdaExpr.getParsedLambdaExpr()->constCast<ParsedLambdaExpression>();
    ...
    auto funcExpr = binder->getExpressionBinder()->bindExpression(*parsedLambdaExpr.getFunctionExpr());
