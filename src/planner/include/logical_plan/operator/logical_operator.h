...
const string LogicalOperatorTypeNames[] = {"LOGICAL_SCAN_NODE_ID", "LOGICAL_EXTEND",
    ...
    "LOGICAL_SCAN_NODE_PROPERTY", "LOGICAL_SCAN_REL_PROPERTY", "LOGICAL_HASH_JOIN",
    "LOGICAL_LOAD_CSV", "LOGICAL_CREATE_NODE", "LOGICAL_UPDATE_NODE", "LOGICAL_DELETE_NODE",
    "LOGICAL_MULTIPLICITY_REDUCER", "LOGICAL_LIMIT", "LOGICAL_SKIP"};
