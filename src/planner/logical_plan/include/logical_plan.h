...
public:
    ...
    inline bool isReadOnly() const {
        return !lastOperator->descendantsContainType(unordered_set<LogicalOperatorType>{LOGICAL_SET,
            LOGICAL_CREATE, LOGICAL_DELETE, LOGICAL_CREATE_NODE_TABLE, LOGICAL_CREATE_REL_TABLE});
    }
