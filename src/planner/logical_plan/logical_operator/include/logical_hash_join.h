...
public:
    ...
    LogicalHashJoin(shared_ptr<NodeExpression> joinNode, JoinType joinType, bool isProbeAcc,
        ...
        : LogicalOperator{std::move(probeSideChild), std::move(buildSideChild)},
          joinNode(std::move(joinNode)), joinType{joinType}, isProbeAcc{isProbeAcc},
    ...
    unique_ptr<LogicalOperator> copy() override {
        return make_unique<LogicalHashJoin>(joinNode, joinType, isProbeAcc, buildSideSchema->copy(),
