...
enum LogicalOperatorType : uint8_t {
    ...
    LOGICAL_DISTINCT,
    LOGICAL_VAR_LENGTH_EXTEND,
    LOGICAL_FIXED_LENGTH_EXTEND,
};
...
const string LogicalOperatorTypeNames[] = {"LOGICAL_SCAN_NODE_ID", "LOGICAL_SELECT_SCAN",
    ...
    "LOGICAL_UNION_ALL", "LOGICAL_RESULT_COLLECTOR", "LOGICAL_DISTINCT",
    "LOGICAL_VAR_LENGTH_EXTEND", "LOGICAL_FIXED_LENGTH_EXTEND"};
