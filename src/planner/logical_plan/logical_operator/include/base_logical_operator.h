...
const string LogicalOperatorTypeNames[] = {"LOGICAL_SCAN_NODE_ID", "LOGICAL_EXTEND",
    "LOGICAL_FLATTEN", "LOGICAL_FILTER", "LOGICAL_INTERSECT", "LOGICAL_PROJECTION",
    "LOGICAL_SCAN_NODE_PROPERTY", "LOGICAL_SCAN_REL_PROPERTY", "LOGICAL_SEMI_MASKER",
    "LOGICAL_HASH_JOIN", "LOGICAL_MULTIPLICITY_REDUCER", "LOGICAL_LIMIT", "LOGICAL_SKIP",
    "LOGICAL_AGGREGATE", "LOGICAL_ORDER_BY", "LOGICAL_EXISTS", "LOGICAL_UNION_ALL",
    "LOGICAL_DISTINCT", "LOGICAL_CREATE", "LOGICAL_SET", "LOGICAL_DELETE", "LOGICAL_ACCUMULATE",
    "LOGICAL_STATIC_TABLE_SCAN", "LOGICAL_FTABLE_SCAN", "LOGICAL_CREATE_NODE_TABLE",
