...
const string LogicalOperatorTypeNames[] = {"LOGICAL_SCAN_NODE_ID", "LOGICAL_SELECT_SCAN",
    ...
    "LOGICAL_SKIP", "LOGICAL_AGGREGATE", "LOGICAL_ORDER_BY", "LOGICAL_EXISTS", "LOGICAL_UNION_ALL",
    "LOGICAL_DISTINCT", "LOGICAL_CREATE", "LOGICAL_SET", "LOGICAL_DELETE", "LOGICAL_ACCUMULATE",
    "LOGICAL_STATIC_TABLE_SCAN", "LOGICAL_CREATE_NODE_TABLE", "LOGICAL_CREATE_REL_TABLE",
