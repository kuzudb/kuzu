...
uint64_t kuzu_query_result_get_num_warning_columns(kuzu_query_result* query_result) {
    return static_cast<QueryResult*>(query_result->_query_result)->getNumWarningColumns();
}
...
kuzu_state kuzu_query_result_get_warning_column_name(kuzu_query_result* query_result,
    uint64_t index, char** out_column_name) {
    auto column_names =
        static_cast<QueryResult*>(query_result->_query_result)->getWarningColumnNames();
...
kuzu_state kuzu_query_result_get_warning_column_data_type(kuzu_query_result* query_result,
    uint64_t index, kuzu_logical_type* out_column_data_type) {
    auto column_data_types =
        static_cast<QueryResult*>(query_result->_query_result)->getWarningColumnDataTypes();
...
uint64_t kuzu_query_result_get_num_warnings(kuzu_query_result* query_result) {
    return static_cast<QueryResult*>(query_result->_query_result)->getNumWarnings();
}
...
bool kuzu_query_result_has_next_warning(kuzu_query_result* query_result) {
    return static_cast<QueryResult*>(query_result->_query_result)->hasNextWarning();
}
...
kuzu_state kuzu_query_result_get_next_warning(kuzu_query_result* query_result,
    kuzu_flat_tuple* out_flat_tuple) {
    try {
        auto flat_tuple = static_cast<QueryResult*>(query_result->_query_result)->getNextWarning();
...
char* kuzu_query_result_to_warning_string(kuzu_query_result* query_result) {
    std::string result_string =
        static_cast<QueryResult*>(query_result->_query_result)->toWarningString();
...
void kuzu_query_result_reset_warning_iterator(kuzu_query_result* query_result) {
    static_cast<QueryResult*>(query_result->_query_result)->resetWarningIterator();
}
