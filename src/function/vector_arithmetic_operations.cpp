...
std::vector<std::unique_ptr<VectorOperationDefinition>> AddVectorOperation::getDefinitions() {
    ...
    result.push_back(getBinaryDefinitionWithPhysicalTypes<operation::Add, interval_t, interval_t>(
...
std::vector<std::unique_ptr<VectorOperationDefinition>> SubtractVectorOperation::getDefinitions() {
    ...
    // date - date → int64
    result.push_back(getBinaryDefinitionWithPhysicalTypes<operation::Subtract, date_t, int64_t>(
        SUBTRACT_FUNC_NAME, DATE, INT64));
    // date - integer → date
    ...
    result.push_back(
        getBinaryDefinitionWithPhysicalTypes<operation::Subtract, timestamp_t, interval_t>(
    ...
    // interval - interval → interval
    result.push_back(
        getBinaryDefinitionWithPhysicalTypes<operation::Subtract, interval_t, interval_t>(
...
std::vector<std::unique_ptr<VectorOperationDefinition>> PowerVectorOperation::getDefinitions() {
    ...
    result.push_back(getBinaryDefinitionWithPhysicalTypes<operation::Power, double_t>(
        POWER_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}
...
std::vector<std::unique_ptr<VectorOperationDefinition>> SinVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Sin, double_t>(
        SIN_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> CosVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Cos, double_t>(
        COS_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> TanVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Tan, double_t>(
        TAN_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> CotVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Cot, double_t>(
        COT_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> AsinVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Asin, double_t>(
        ASIN_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> AcosVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Acos, double_t>(
        ACOS_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> AtanVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Atan, double_t>(
        ATAN_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}
...
std::vector<std::unique_ptr<VectorOperationDefinition>> SqrtVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Sqrt, double_t>(
        SQRT_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}

std::vector<std::unique_ptr<VectorOperationDefinition>> CbrtVectorOperation::getDefinitions() {
    std::vector<std::unique_ptr<VectorOperationDefinition>> result;
    result.push_back(getUnaryDefinitionWithPhysicalTypes<operation::Cbrt, double_t>(
        CBRT_FUNC_NAME, DOUBLE, DOUBLE));
    return result;
}
