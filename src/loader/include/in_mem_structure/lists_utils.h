...
public:
    ...
    static void calculateListHeadersTask(node_offset_t numNodeOffsets, uint32_t elementSize,
    ...
    static void calculateListsMetadataTask(uint64_t numNodeOffsets, uint32_t elementSize,
    ...
    // in the in-mem pages.
    static void calcPageElementCursor(uint32_t header, uint64_t reversePos,
