...
std::string ExtendPrintInfo::toString() const {
...
void Extend::initLocalStateInternal(ResultSet* resultSet, ExecutionContext* context) {
...
bool Extend::getNextTuplesInternal(ExecutionContext* context) {
