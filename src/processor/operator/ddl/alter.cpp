...
void Alter::alterTable(main::ClientContext* clientContext, const TableCatalogEntry& entry,
    ...
    case AlterType::DROP_PROPERTY: {
        ...
        appendMessage(stringFormat("Property {} dropped from table {}.", propertyName, tableName), memoryManager);
    } break;
    ...
    case AlterType::DROP_FROM_TO_CONNECTION: {
        ...
        appendMessage(stringFormat("{}->{} dropped from table {}.", fromTableName, toTableName, tableName), memoryManager);
    } break;
