...
const string PhysicalOperatorTypeNames[] = {"AGGREGATE", "AGGREGATE_SCAN", "COLUMN_EXTEND",
    ...
    "CREATE_REL_TABLE", "CROSS_PRODUCT", "DELETE_NODE", "DELETE_REL", "DROP_TABLE", "EXISTS",
    "FACTORIZED_TABLE_SCAN", "FILTER", "FLATTEN", "HASH_JOIN_BUILD", "HASH_JOIN_PROBE",
    "INDEX_SCAN", "INTERSECT_BUILD", "INTERSECT", "LIMIT", "LIST_EXTEND", "MULTIPLICITY_REDUCER",
    "PROJECTION", "SCAN_REL_PROPERTY", "RESULT_COLLECTOR", "SCAN_NODE_ID",
    "SCAN_STRUCTURED_PROPERTY", "SEMI_MASKER", "SET_STRUCTURED_NODE_PROPERTY", "SKIP", "ORDER_BY",
