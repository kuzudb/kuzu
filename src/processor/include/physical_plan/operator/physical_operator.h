...
const string PhysicalOperatorTypeNames[] = {"AGGREGATE", "AGGREGATE_SCAN", "COLUMN_EXTEND",
    ...
    "HASH_JOIN_PROBE", "INTERSECT", "INTERSECT_BUILD", "LEFT_NESTED_LOOP_JOIN", "LIMIT",
    "LIST_EXTEND", "MULTIPLICITY_REDUCER", "MW_INTERSECT", "PROJECTION", "READ_REL_PROPERTY",
    "RESULT_COLLECTOR", "RESULT_SCAN", "SCAN_NODE_ID", "SCAN_STRUCTURED_PROPERTY",
    "SCAN_UNSTRUCTURED_PROPERTY", "SEMI_MASKER", "SET", "SKIP", "SORTER", "ORDER_BY",
    "ORDER_BY_MERGE", "ORDER_BY_SCAN", "UNION_ALL_SCAN", "CREATE_NODE_TABLE", "CREATE_REL_TABLE"};
