...
const string PhysicalOperatorTypeNames[] = {"AGGREGATE", "AGGREGATE_SCAN", "COLUMN_EXTEND",
    ...
    "HASH_JOIN_PROBE", "INTERSECT_BUILD", "INTERSECT", "LIMIT", "LIST_EXTEND",
    "MULTIPLICITY_REDUCER", "PROJECTION", "READ_REL_PROPERTY", "RESULT_COLLECTOR", "SCAN_NODE_ID",
    "SCAN_STRUCTURED_PROPERTY", "SCAN_UNSTRUCTURED_PROPERTY", "SEMI_MASKER",
