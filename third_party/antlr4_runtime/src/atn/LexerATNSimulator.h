...
protected:
    ...
    virtual void accept(CharStream* input, const Ref<LexerActionExecutor>& lexerActionExecutor,
    ...
    /// cref="Lexer#getLine"/>, and <seealso cref="Lexer#getCharPositionInLine"/>, properly reflect
    /// the current lexer state. This method should restore {@code input} and the simulator to the
    /// original state before returning (i.e. undo the actions made by the call to <seealso
    /// cref="#consume"/>.
    /// </summary>
    /// <param name="input"> The input stream. </param>
