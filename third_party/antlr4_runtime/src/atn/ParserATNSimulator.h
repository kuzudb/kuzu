...
public:
    ...
    virtual size_t adaptivePredict(
...
protected:
    ...
    virtual std::unique_ptr<ATNConfigSet> computeReachSet(
    ...
    virtual std::unique_ptr<ATNConfigSet> computeStartState(
    ...
    /// on {@code to} </returns>
    virtual dfa::DFAState* addDFAEdge(
