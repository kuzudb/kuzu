...
// (e.g. -1) and vice versa. This is needed mostly for intervals to keep their original order and
// for toString() methods to print the original numeric value (e.g. for tests).
