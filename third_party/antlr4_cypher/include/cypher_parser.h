...
public:
  ...
  enum {
    ...
    RuleOC_RelationshipTypes = 83, RuleOC_NodeLabels = 84, RuleOC_NodeLabel = 85, 
    RuleOC_RangeLiteral = 86, RuleKU_RecursiveRelationshipComprehension = 87, 
    RuleKU_IntermediateNodeProjectionItems = 88, RuleKU_IntermediateRelProjectionItems = 89, 
    RuleOC_LowerBound = 90, RuleOC_UpperBound = 91, RuleOC_LabelName = 92, 
    RuleOC_RelTypeName = 93, RuleOC_Expression = 94, RuleOC_OrExpression = 95, 
    RuleOC_XorExpression = 96, RuleOC_AndExpression = 97, RuleOC_NotExpression = 98, 
    RuleOC_ComparisonExpression = 99, RuleKU_ComparisonOperator = 100, RuleKU_BitwiseOrOperatorExpression = 101, 
