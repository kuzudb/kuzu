...
public:
  enum {
    ...
    T__44 = 45, T__45 = 46, GLOB = 47, COPY = 48, FROM = 49, NPY = 50, NODE = 51, 
    TABLE = 52, DROP = 53, ALTER = 54, DEFAULT = 55, RENAME = 56, ADD = 57, 
    PRIMARY = 58, KEY = 59, REL = 60, TO = 61, EXPLAIN = 62, PROFILE = 63, 
