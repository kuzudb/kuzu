...
const std::map<int, const char*> _Type_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(8, _kTypeValues, _kTypeNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _ConvertedType_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(22, _kConvertedTypeValues, _kConvertedTypeNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _FieldRepetitionType_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(3, _kFieldRepetitionTypeValues, _kFieldRepetitionTypeNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _Encoding_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(8, _kEncodingValues, _kEncodingNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _CompressionCodec_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(7, _kCompressionCodecValues, _kCompressionCodecNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _PageType_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(4, _kPageTypeValues, _kPageTypeNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _BoundaryOrder_VALUES_TO_NAMES(::kuzu_apache::thrift::TEnumIterator(3, _kBoundaryOrderValues, _kBoundaryOrderNames), ::kuzu_apache::thrift::TEnumIterator(-1, NULL, NULL));
