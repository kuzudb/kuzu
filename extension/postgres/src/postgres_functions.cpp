...
struct PostgresClearCacheBindData : public duckdb_extension::DuckDBClearCacheBindData {
...
static offset_t postgresClearCacheTableFunc(TableFuncInput& input, TableFuncOutput& output) {
    ...
    auto bindData = input.bindData->constPtrCast<duckdb_extension::DuckDBClearCacheBindData>();
