...
static const symbol s_0_1[12] = {0xD1, 0x8B, 0xD0, 0xB2, 0xD1, 0x88, 0xD0, 0xB8, 0xD1, 0x81, 0xD1,
    0x8C};
static const symbol s_0_2[12] = {0xD0, 0xB8, 0xD0, 0xB2, 0xD1, 0x88, 0xD0, 0xB8, 0xD1, 0x81, 0xD1,
    0x8C};
...
static const struct among a_0[9] = {{10, s_0_0, -1, 1, 0}, {12, s_0_1, 0, 2, 0},
    {12, s_0_2, 0, 2, 0}, {2, s_0_3, -1, 1, 0}, {4, s_0_4, 3, 2, 0}, {4, s_0_5, 3, 2, 0},
    {6, s_0_6, -1, 1, 0}, {8, s_0_7, 6, 2, 0}, {8, s_0_8, 6, 2, 0}};
...
static const struct among a_1[26] = {{6, s_1_0, -1, 1, 0}, {6, s_1_1, -1, 1, 0},
    {4, s_1_2, -1, 1, 0}, {4, s_1_3, -1, 1, 0}, {4, s_1_4, -1, 1, 0}, {4, s_1_5, -1, 1, 0},
    {4, s_1_6, -1, 1, 0}, {4, s_1_7, -1, 1, 0}, {4, s_1_8, -1, 1, 0}, {4, s_1_9, -1, 1, 0},
    {4, s_1_10, -1, 1, 0}, {4, s_1_11, -1, 1, 0}, {4, s_1_12, -1, 1, 0}, {4, s_1_13, -1, 1, 0},
    {6, s_1_14, -1, 1, 0}, {6, s_1_15, -1, 1, 0}, {4, s_1_16, -1, 1, 0}, {4, s_1_17, -1, 1, 0},
    {4, s_1_18, -1, 1, 0}, {4, s_1_19, -1, 1, 0}, {4, s_1_20, -1, 1, 0}, {4, s_1_21, -1, 1, 0},
    {4, s_1_22, -1, 1, 0}, {4, s_1_23, -1, 1, 0}, {6, s_1_24, -1, 1, 0}, {6, s_1_25, -1, 1, 0}};
...
static const struct among a_2[8] = {{4, s_2_0, -1, 1, 0}, {6, s_2_1, 0, 2, 0}, {6, s_2_2, 0, 2, 0},
    {2, s_2_3, -1, 1, 0}, {4, s_2_4, 3, 1, 0}, {6, s_2_5, 4, 2, 0}, {4, s_2_6, -1, 1, 0},
    {4, s_2_7, -1, 1, 0}};
...
static const struct among a_4[46] = {{4, s_4_0, -1, 2, 0}, {4, s_4_1, -1, 1, 0},
    {6, s_4_2, 1, 2, 0}, {4, s_4_3, -1, 2, 0}, {4, s_4_4, -1, 1, 0}, {6, s_4_5, 4, 2, 0},
    {4, s_4_6, -1, 2, 0}, {4, s_4_7, -1, 1, 0}, {6, s_4_8, 7, 2, 0}, {4, s_4_9, -1, 1, 0},
    {6, s_4_10, 9, 2, 0}, {6, s_4_11, 9, 2, 0}, {6, s_4_12, -1, 1, 0}, {6, s_4_13, -1, 2, 0},
    {2, s_4_14, -1, 2, 0}, {4, s_4_15, 14, 2, 0}, {4, s_4_16, -1, 1, 0}, {6, s_4_17, 16, 2, 0},
    {6, s_4_18, 16, 2, 0}, {4, s_4_19, -1, 1, 0}, {6, s_4_20, 19, 2, 0}, {6, s_4_21, -1, 1, 0},
    {6, s_4_22, -1, 2, 0}, {6, s_4_23, -1, 1, 0}, {8, s_4_24, 23, 2, 0}, {8, s_4_25, 23, 2, 0},
    {4, s_4_26, -1, 1, 0}, {6, s_4_27, 26, 2, 0}, {6, s_4_28, 26, 2, 0}, {2, s_4_29, -1, 1, 0},
    {4, s_4_30, 29, 2, 0}, {4, s_4_31, 29, 2, 0}, {2, s_4_32, -1, 1, 0}, {4, s_4_33, 32, 2, 0},
    {4, s_4_34, 32, 2, 0}, {4, s_4_35, -1, 2, 0}, {4, s_4_36, -1, 1, 0}, {4, s_4_37, -1, 2, 0},
    {2, s_4_38, -1, 1, 0}, {4, s_4_39, 38, 2, 0}, {4, s_4_40, -1, 1, 0}, {6, s_4_41, 40, 2, 0},
    {6, s_4_42, 40, 2, 0}, {4, s_4_43, -1, 1, 0}, {6, s_4_44, 43, 2, 0}, {6, s_4_45, 43, 1, 0}};
...
static const struct among a_5[36] = {{2, s_5_0, -1, 1, 0}, {4, s_5_1, -1, 1, 0},
    {6, s_5_2, 1, 1, 0}, {4, s_5_3, -1, 1, 0}, {2, s_5_4, -1, 1, 0}, {2, s_5_5, -1, 1, 0},
    {2, s_5_6, -1, 1, 0}, {4, s_5_7, 6, 1, 0}, {4, s_5_8, 6, 1, 0}, {2, s_5_9, -1, 1, 0},
    {4, s_5_10, 9, 1, 0}, {4, s_5_11, 9, 1, 0}, {2, s_5_12, -1, 1, 0}, {4, s_5_13, -1, 1, 0},
    {4, s_5_14, -1, 1, 0}, {2, s_5_15, -1, 1, 0}, {4, s_5_16, 15, 1, 0}, {4, s_5_17, 15, 1, 0},
    {2, s_5_18, -1, 1, 0}, {4, s_5_19, 18, 1, 0}, {4, s_5_20, 18, 1, 0}, {6, s_5_21, 18, 1, 0},
    {8, s_5_22, 21, 1, 0}, {6, s_5_23, 18, 1, 0}, {2, s_5_24, -1, 1, 0}, {4, s_5_25, 24, 1, 0},
    {6, s_5_26, 25, 1, 0}, {4, s_5_27, 24, 1, 0}, {4, s_5_28, 24, 1, 0}, {4, s_5_29, -1, 1, 0},
    {6, s_5_30, 29, 1, 0}, {4, s_5_31, -1, 1, 0}, {4, s_5_32, -1, 1, 0}, {6, s_5_33, 32, 1, 0},
    {4, s_5_34, -1, 1, 0}, {2, s_5_35, -1, 1, 0}};
...
static const struct among a_7[4] = {{6, s_7_0, -1, 1, 0}, {2, s_7_1, -1, 3, 0},
    {8, s_7_2, -1, 1, 0}, {2, s_7_3, -1, 2, 0}};
