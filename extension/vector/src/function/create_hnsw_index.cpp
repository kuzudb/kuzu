...
static std::unique_ptr<PhysicalOperator> getPhysicalPlan(
    PlanMapper* planMapper, const planner::LogicalOperator* logicalOp) {
    ...
    auto finalizeCallOp = std::make_unique<TableFunctionCall>(std::move(info),
