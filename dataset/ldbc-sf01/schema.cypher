...
create rel table Comment_hasCreator (FROM Comment TO Person);
...
create rel table hasMember (FROM Forum TO Person, joinDate INT64);
create rel table hasModerator (FROM Forum TO Person);
create rel table Forum_hasTag (FROM Forum TO Tag);
...
create rel table likes_Comment (FROM Person TO Comment, creationDate INT64);
create rel table likes_Post (FROM Person TO Post, creationDate INT64);
...
create rel table Post_hasTag (FROM Post TO Tag);
