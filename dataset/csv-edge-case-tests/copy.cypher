...
COPY `empty-lines-single-column` (B) FROM "dataset/csv-edge-case-tests/empty-lines-single-column.csv";
...
COPY `mixed-empty-lines-single-column` (B) FROM "dataset/csv-edge-case-tests/mixed-empty-lines-single-column.csv";
