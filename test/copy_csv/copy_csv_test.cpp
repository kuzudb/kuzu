...
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/copy-csv-node-property-test/"); }
};

class CopyCSVSpecialCharTest : public InMemoryDBTest {
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/copy-csv-special-char-test/"); }
};

class CopyCSVReadLists2BytesPerEdgeTest : public InMemoryDBTest {
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/read-list-tests/2-bytes-per-edge/"); }
};

class CopyCSVReadLists3BytesPerEdgeTest : public InMemoryDBTest {
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/read-list-tests/3-bytes-per-edge/"); }
};

class CopyCSVReadLists4BytesPerEdgeTest : public InMemoryDBTest {
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/read-list-tests/4-bytes-per-edge/"); }
};

class CopyCSVReadLists5BytesPerEdgeTest : public InMemoryDBTest {
public:
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/read-list-tests/5-bytes-per-edge/"); }
};

class CopyCSVLongStringTest : public InMemoryDBTest {
    string getInputCSVDir() override { return TestHelper::appendKuzuRootPath("dataset/copy-csv-fault-tests/long-string/"); }
};
...
TEST_F(CopyNodeCSVPropertyTest, NodeStructuredStringPropertyTest) {
    ...
    string fName = TestHelper::appendKuzuRootPath("dataset/copy-csv-node-property-test/vPerson.csv");
