...
TEST_F(CApiFlatTupleTest, GetValue) {
    ...
    ASSERT_EQ(valueCpp->getDataType().getTypeID(), DataTypeID::STRING);
    ...
    ASSERT_NE(valueCpp, nullptr);
    ASSERT_EQ(valueCpp->getDataType().getTypeID(), DataTypeID::INT64);
    ...
    valueCpp = static_cast<Value*>(value->_value);
    ASSERT_NE(valueCpp, nullptr);
    ASSERT_EQ(valueCpp->getDataType().getTypeID(), DataTypeID::FLOAT);
