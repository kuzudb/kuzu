...
def test_bool_param(establish_connection: ConnDB) -> None:
...
def test_int_param(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_double_param(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_str_param(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_date_param(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_timestamp_param(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
    result = conn.execute(
...
def test_param_error1(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_param_error2(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
...
def test_param_error3(establish_connection: ConnDB) -> None:
    conn, db = establish_connection
    with pytest.raises(RuntimeError, match="Parameters must be a dict"):
