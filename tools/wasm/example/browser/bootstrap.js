...
if (!fs.existsSync(KUZU_WASM_INDEX_PATH) || !fs.existsSync(KUZU_WASM_WORKER_PATH)) {
    console.log("Kùzu WebAssembly module not found. Please run `npm i` to install the dependencies.");
    process.exit(1);
}

console.log("Copying Kùzu WebAssembly module to public directory...");
