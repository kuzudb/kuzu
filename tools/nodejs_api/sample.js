...
function executeAllCallback(queryResult) {
 ...
 function executeEachCallback(queryResult) {
    console.log(queryResult);
    const singleRowQueryResult = queryResult.each();
    console.log(singleRowQueryResult);
    return singleRowQueryResult;
}
...
connection.execute(createTableQuery, executeEachCallback);
